...
class UpdateUserTestCase(TestCase):
    ...
    def test_update_user_ok(self):
        ...
        'username': 'teste','cep':'58010780','logradouro':'testee','numero':'280',
        'complemento':'casa', 'telefone':'986602823', 'bairro':'Centro','cidade':'Joao Pessoa',
        'nome_mae': 'Maria teste', 'nome_pai':'teste', 'data_nascimento': '22/06/1990'}
